...
public class generator {
    @Test
    public void run() {
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/wxdemo?serverTimezone=GMT%2B8", "root", "root")
                ...
                .packageConfig(builder -> {
                    builder.parent("com.hnust.wx_ticket") // 父包模块名 默认值:com.baomidou
                ...
                .strategyConfig(builder -> {
                    builder.addInclude("film","ticket","seat") // 设置需要生成的表名 可边长参数“user”, “user1”
